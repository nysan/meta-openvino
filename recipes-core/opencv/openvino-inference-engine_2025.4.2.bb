...
SRCREV_FORMAT = "openvino_mkl_ade_mlas"
...
# Frontends
PACKAGECONFIG[onnx] = "-DENABLE_OV_ONNX_FRONTEND=ON, -DENABLE_OV_ONNX_FRONTEND=OFF, protobuf protobuf-native,"
...
SRC_URI += "${@bb.utils.contains('PACKAGECONFIG', 'opencl', \
